...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_COLEMAK] = LAYOUT_65_ansi_blocker(
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            LT(_NAV, KC_SPC),          MO(_FN), KC_RCTL,          KC_LEFT, KC_DOWN, KC_RGHT
    ),

    [_FN] = LAYOUT_65_ansi_blocker(
        _______, KC_F1,       KC_F2,        KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, QK_BOOT,
        _______, DF(_QWERTY), DF(_COLEMAK), _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_HOME,
    ...
    [_NAV] = LAYOUT_65_ansi_blocker(
        ...
        KC_CAPS, _______, _______, _______, _______, _______, _______, KC_LEFT,    KC_DOWN, KC_RGHT,    KC_END,  _______,          _______, _______,
